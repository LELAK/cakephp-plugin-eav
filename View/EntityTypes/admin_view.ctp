<div class="entityTypes view">
    <h2><?php echo __d('eav', 'Tipo de Entidade'); ?></h2>
    <dl>
        <dt><?php echo __d('eav', 'Id'); ?></dt>
        <dd>
            <?php echo h($entityType['EavEntityType']['id']); ?>
            &nbsp;
        </dd>
        <dt><?php echo __d('eav', 'Nome'); ?></dt>
        <dd>
            <?php echo h($entityType['EavEntityType']['name']); ?>
            &nbsp;
        </dd>
        <dt><?php echo __d('eav', 'Criado'); ?></dt>
        <dd>
            <?php echo h($entityType['EavEntityType']['created']); ?>
            &nbsp;
        </dd>
        <dt><?php echo __d('eav', 'Modificado'); ?></dt>
        <dd>
            <?php echo h($entityType['EavEntityType']['modified']); ?>
            &nbsp;
        </dd>
    </dl>
</div>
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__d('eav', 'Editar tipo de entidade'), array('action' => 'edit', $entityType['EavEntityType']['id'])); ?> </li>
        <li><?php echo $this->Form->postLink(__d('eav', 'Deletar tipo de entidade'), array('action' => 'delete', $entityType['EavEntityType']['id']), null, __d('eav', 'Tem certeza que deseja excluír "%s"?', $entityType['EavEntityType']['name'])); ?> </li>
        <li><?php echo $this->Html->link(__d('eav', 'Listar tipos de entidade'), array('action' => 'index')); ?> </li>
        <li><?php echo $this->Html->link(__d('eav', 'Novo tipo de entidade'), array('action' => 'add')); ?> </li>
...
<div class="related">
    ...
    <?php if (!empty($entityType['EavAttribute'])): ?>
        <table cellpadding = "0" cellspacing = "0">
            ...
            <?php
            $i = 0;
            foreach ($entityType['EavAttribute'] as $attribute):
                ?>
                <tr>
